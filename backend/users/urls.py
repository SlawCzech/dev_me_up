...
urlpatterns = [
    ...
    path('users/password-reset/', views.PasswordReminderView.as_view(), name='password_reminder'),
    path('users/password-reset/<str:uid>/<str:token>/', views.PasswordResetView.as_view(), name='password_reset'),
